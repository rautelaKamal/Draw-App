...
app.post("/signin", function (req, res) {
    var data = types_1.SigninSchema.safeParse(req.body);
    if (!data.success) {
        return res.json({
            message: "incorrect inputs"
        });
...
app.post("/room ", middleware_1.middleware, function (req, res) {
    var data = types_1.CreateRoomSchema.safeParse(req.body);
    if (!data.success) {
        return res.json({
            message: "incorrect inputs"
        });
